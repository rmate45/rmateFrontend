...
const RetireAgeCard = () => (
  <div className="bg-white rounded-[20px] shadow p-5">
    ...
    <p className="text-sm jost text-left mb-5 text-introPrimary">
      You can retire as early as <strong>63</strong> with a comfortable lifestyle
      in Los Angeles, CA, by saving <strong>$1,000/month</strong>.
    </p>

    <div className="flex flex-wrap xl:flex-nowrap">
      <div className="w-full h-64">
        <ResponsiveContainer>
          <BarChart data={barData} margin={{ top: 20, right: 20, bottom: 30, left: 20 }}>
            <XAxis
              dataKey="savings"
              label={{
              ...
              tick={{ style: { fontFamily: "Jost, sans-serif", fontSize: 12 } }}
            />
            <YAxis
              domain={[60, 80]}
