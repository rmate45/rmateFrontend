...
const HeroSection = ({ searchIcon, onSearch, onVoiceSearch }) => {
  ...
  return (
    <>
      <div   onClick={() => window.open("/quiz")} className="bg-introPrimary cursor-pointer sm:min-h-[606px] flex items-center justify-between text-white py-12 md:py-28 md:pb-42 text-center px-2 bg-no-repeat bg-cover bg-center relative bg-[url(/src/assets/mobile-image.png)] sm:bg-[url(/src/assets/bgImage.png)]" >
