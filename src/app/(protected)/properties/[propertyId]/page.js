...
import ReleaseTenantModal from "@/components/modals/ReleaseTenantModal/ReleaseTenantModal";
    ...
    <div className="flex gap-4">
      ...
      <div className="flex flex-col flex-1 gap-4">
        ...
        <TenantLeaseCard
          ...
          onEdit={() => console.log("Edit clicked")}
          onRelease={() => setIsReleaseModalOpen(true)}
        />
      </div>
      ...
      >
        <ReleaseTenantModal onClose={() => setIsReleaseModalOpen(false)} />
      </Modal>
    </div>
  );
};
